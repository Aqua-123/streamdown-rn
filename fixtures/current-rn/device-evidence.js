export const DEVICE_SCENARIO_PHASES = Object.freeze({
  ...
  'streaming-fade-word-4-at-16ms': ['fade-word-active', 'fade-word-complete'],
  'streaming-fade-char-12-at-40ms': ['fade-char-active', 'fade-char-complete'],
  'streaming-slide-word-32-at-120ms': ['slide-word-active', 'slide-word-complete'],
  'streaming-unanimated-and-reduced-motion': ['unanimated-complete', 'reduced-motion-complete'],
...
export function deviceScenarioSignal(scenario) {
  return {
    ...
    'streaming-fade-word-4-at-16ms': 'fade-word-stream-observed',
    'streaming-fade-char-12-at-40ms': 'fade-char-stream-observed',
    'streaming-slide-word-32-at-120ms': 'slide-word-stream-observed',
    'streaming-unanimated-and-reduced-motion': 'immediate-stream-modes-observed',
