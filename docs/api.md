...
The `icons` prop accepts optional `copy`, `check`, `share`, `download`, `fullscreen`, `close`, `retry`, `zoomIn`, `zoomOut`, and `zoomReset` overrides. Successful copy actions temporarily use `check`.
