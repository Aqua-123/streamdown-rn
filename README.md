...
The Expo 56 sample app exercises streaming controls, static rendering, themes, tables, task lists, code, math, Mermaid, CJK/RTL text, incomplete Markdown, native actions, and long-stream performance.
